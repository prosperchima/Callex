...
<!--          <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <!-- Content Row -->
          <section class="pt-5 mt-5"></section>
          <section>
             ...
             <form id="" action="Router" method="POST">
                  <div id="form1" >
                      <h5 class="text-success">${info}</h5>
                        ...
                        <div class="form-group">
                          <input type="text" class="form-control"name="recipient_number" id="recipient_number" placeholder="Enter Recipient Number(s)">
                        </div>
                        <div class="form-group">
                            <textarea type="text" class="form-control"name="home_address" id="home_address" placeholder="Write message here"></textarea>
                        </div>
                        
                      </div>

                 <button type="submit" style="background-color: #0E6CFF; color:#fff; " class="btn">Submit</button>
